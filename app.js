...
app.post('/resetpassword', function(req, res){
  if(req.body.password != req.body.confirm_password){
    res.render('session/resetPassword', {errors: {confirm_password: {message: 'No coinciden las contraseñas ingresadas.'}}})
    return
  }
  Usuario.findOne({ email: req.body.email }, function(err, usuario){
    ...
    usuario.save(function(err){
      if(err) {
        ...
        res.render('session/login', {info: {message: "Su contraseña ha sido reestablecida con éxito."}})
      }
    })
  })
})
